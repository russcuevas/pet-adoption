...
<body>
    ...
    <!-- HEADER NAVBAR -->
    <header style="background-color: rgb(200, 214, 120);">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container">
                <a style="color: black !important;" class="navbar-brand" href="#">PAWS-MS</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item" style="background-color: rgb(255, 255, 255); border-radius: 50px;">
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color: rgb(200, 214, 120);">
                    <h5 class="modal-title" id="loginModalLabel"></h5>
                    <button style="background: none;" type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" style="font-weight: 900;">X</span>
                    </button>
                </div>
        ...
        <div class="container">
            <div class="row banner-section">
                <div class="col-md-6 banner-text">
                    ...
                    <p style="text-align: justify;" class="home-p">Discover a world of care and companionship with our Pet Management System. Whether 
